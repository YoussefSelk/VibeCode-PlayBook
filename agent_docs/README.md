...
- `.agents/reference-links.md`: objective-based external references for fast, low-noise research

Inter-agent handoff:

- when passing work between agents, follow the handoff contract in `AGENTS.md`
- do not hand off with vague text; include evidence and done-criteria
